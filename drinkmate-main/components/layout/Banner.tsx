...
export default function Banner() {
  ...
  return (
    <div 
      className={`bg-gradient-to-r from-[#12d6fa] to-[#0bc4e8] text-white text-center py-2 sm:py-3 text-xs sm:text-sm flex items-center justify-center shadow-lg ${isRTL ? 'font-cairo' : 'font-montserrat'}`} 
      dir={isRTL ? 'rtl' : 'ltr'}
