    ...
    <PageLayout currentPage="shop-flavor">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-6">
          ...
          <ChevronRight className="w-4 h-4 mx-1" />
          <Link href="/shop/flavor" className="hover:text-[#12d6fa]">Bundles</Link>
          <ChevronRight className="w-4 h-4 mx-1" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div>
            <div className="bg-white rounded-lg mb-4 flex items-center justify-center h-96">
              <Image
                src={activeImage || (bundle.images && bundle.images.length > 0 ? bundle.images[0].url : "/images/01 - Flavors/Strawberry-Lemon-Flavor.png")}
                alt={bundle.name}
                width={300}
                height={300}
