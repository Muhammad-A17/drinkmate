  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const flavorProducts = allProducts.filter((product: any) => 
          product.category === 'flavors' || product.category === 'flavor'
        )
        ...
        const premiumSyrups = flavorProducts.filter((product: any) => 
        ...
        const shopSyrups = flavorProducts.filter((product: any) => 
  ...
  return (
    <PageLayout currentPage="shop-flavor">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-xl font-medium mb-6">Explore Our Premium Italian Syrups</h1>
        ...
        {isLoading ? (
          ...
          <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {bundles.map((bundle) => (
                    <div key={bundle._id} className="bg-white border border-gray-100 hover:shadow-sm transition-shadow flex flex-col relative">
                      <Link href={`/shop/flavor/bundles/${bundle._id}`} className="block">
                        <div className="relative h-48 bg-white mb-2 flex items-center justify-center">
                          <Image
                            src={bundle.image}
                            alt={bundle.name}
                      ...
                      <div className="px-3 pb-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button 
                            onClick={() => window.location.href = `/shop/flavor/bundles/${bundle._id}`}
                            className="bg-[#16d6fa] hover:bg-[#14c4e8] text-black font-bold rounded-sm px-3 py-1 h-6 text-xs"
                          >
                            BUY
                          </Button>
            ...
            <div className="mb-12">
              <h2 className="text-lg font-medium mb-4">Premium Italian Syrups</h2>
              {premiumSyrups.length > 0 ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Premium Syrups Available</h3>
                  <p className="text-gray-500 mb-4">We're working on adding premium Italian syrups to our collection.</p>
                  <Button 
            ...
            {/* Shop Syrups Section */}
            <div className="mb-12">
              <h2 className="text-lg font-medium mb-4">Shop Syrups</h2>
              {shopSyrups.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">No Shop Syrups Available</h3>
                  <p className="text-gray-500 mb-4">We're working on adding shop syrups to our collection.</p>
                  <Button 
                    onClick={() => window.location.href = '/admin/products'}
                    className="bg-[#12d6fa] hover:bg-[#0fb8d9] text-white"
                  >
