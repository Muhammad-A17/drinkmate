...
export default function AccessoriesBundleDetailPage() {
  ...
  const fetchBundle = async () => {
    try {
      setIsLoading(true)
      console.log('Fetching accessory bundle details for slug:', slug);
      
      const response = await shopAPI.getBundleFlexible(slug)
      console.log('Accessory bundle fetch successful:', response.bundle?.name);
      ...
      console.error("Error fetching accessory bundle:", error)
