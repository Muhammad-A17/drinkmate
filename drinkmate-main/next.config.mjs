...
const nextConfig = {
  ...
  async rewrites() {
    return [
      {
        source: '/api/:path*',
        destination: `${process.env.NEXT_PUBLIC_API_URL || 'https://drinkmate-production.up.railway.app'}/:path*`,
      },
  ...
  images: {
    ...
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'drinkmate-main-production.up.railway.app',
        port: '',
        pathname: '/**',
      },
      {
